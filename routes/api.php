...
Route::middleware(['auth:sanctum', 'tenant.isolation'])->group(function () {
    ...
    // Notifications API - also available via web auth for frontend
...
// Notifications API - also available via web auth for frontend compatibility
...
Route::prefix('realtime-chat')->middleware(['web', 'auth'])->group(function () {
    ...
    Route::get('conversations/{conversation}/messages/since/{lastMessageId}', [RealTimeChatController::class, 'getMessagesSince']);
