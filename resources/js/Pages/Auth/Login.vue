      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div class="mb-6">
          <button
            ...
            class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl shadow-sm bg-white text-gray-700 hover:bg-gray-50 transition-all duration-200 font-medium"
          >
        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <button
            ...
            class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
