        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div v-if="activeTab === 'contacts'" class="p-2">
            ...
            <div 
              ...
              :class="{ 'bg-green-50 border border-green-200': user.is_online }"
            >
              <!-- Avatar -->
              <div class="relative flex-shrink-0">
                <img 
                ...
                <div 
                  ...
                  :class="user.is_online ? getStatusColor(user.online_status) : 'bg-gray-400'"
                ></div>
              </div>
              ...
              <div class="ml-3 flex-1 min-w-0">
                <div class="flex items-center justify-between">
                  ...
                  <span v-if="user.is_online" class="text-xs text-green-600 font-medium">Online</span>
                  <span v-else class="text-xs text-gray-400">{{ formatLastSeen(user.last_seen_at) }}</span>
                </div>
                <p class="text-xs text-gray-500 truncate">
                  {{ user.status_message || getStatusText(user.is_online ? user.online_status : 'offline') }}
                </p>
              </div>
...
const onlineCount = computed(() => {
  return props.onlineUsers.filter(user => user.is_online).length
})
